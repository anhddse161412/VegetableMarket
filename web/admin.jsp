                    ...
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                <a href="MainController?action=SearchProduct&SearchProduct=" class="btn btn-secondary"><i class="material-icons">&#xE24D;</i> <span>Product Management</span></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <c:if test="${not empty requestScope.USER_LIST}">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${requestScope.USER_LIST}" var="o">
                                        <tr>
                                            <td>${o.userID}</td>
                                            <td>${o.fullName}</td>    
                                            <td>${o.roleID}</td>   
